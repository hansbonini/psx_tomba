...
extern void displayDebugScreen(void)
{
    ...
    FontDebugPrintf(102, 26, 0U, "EVENT TEST MENU");
    FontDebugPrintf(52, 36, 0U, "TOMBA DECOMPILATION PROJECT");
    sprintf(&SPRINTF_BUFFER_MSG, "EVENT TEST = %02d", GAME.unk21);
    FontDebugPrintf(32, 206, 0U, &SPRINTF_BUFFER_MSG);
    sprintf(&SPRINTF_BUFFER_MSG, "*");
    FontDebugPrintf(24, 206, (u_long) (*(u_short*)&PSX_SCRATCH[0x1F6] & 0xC) >> 2, &SPRINTF_BUFFER_MSG);
    /*
